:: Periodically one might observe:
:: Done building target "_ProcessDocuments" in project "chm.helpproj" -- FAILED.
:: This 'clean' script is useful in resolving this build problem 
@echo off
setlocal
:set the window size
...
call "%_msbuild%" ..\..\wix4\src\Setup\CoreMsi\CoreMsi.wixproj /t:Clean /v:diag /l:FileLogger,Microsoft.Build.Engine;logfile="%~dp0\wix4.log"
